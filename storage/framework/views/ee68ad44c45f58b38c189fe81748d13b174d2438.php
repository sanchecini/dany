...
<div class="form-row">
    <div class="form-group col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="cliente" id="cliente" aria-describedby="helpId" required>
        </div>
    </div>
    <div class="form-group col-md-6">
        <div class="form-group">
    ...
    <div class="form-group col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="municipio" id="municipio" aria-describedby="helpId" >
        </div>
    </div>
    <div class="form-group col-md-6">
        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\danis\resources\views/admin/cliente/_form.blade.php ENDPATH**/ ?>